...
const { playStatus, videoRef, currentTime, duration } = storeToRefs(playerStore)
  ...
  <div class="bottom-panel h-[300px] bg-[#17171e] pb-2 px-4 text-white flex flex-col">
    ...
    <div class="flex border-y justify-between border-[#272836] h-[40px] items-center gap-2">
      ...
      <div class="flex items-center gap-2">
        <button class="btn-control" @click="() => {if (videoRef) videoRef.currentTime -= 5}"><IconPrev /></button>
        ...
        <button class="btn-control" @click="() => {if (videoRef) videoRef.currentTime += 5}"><IconNext /></button>
      ...
      <div class="flex gap-4">
        ...
        <button @click="playerStore.toggleFullScreen">预览</button>
      </div>
    </div>
